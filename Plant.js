...
//this starts the planting stage pnce the game begins 
function Start () {
...
//lateupdate tries to update the sceen every frame. trying to update the stages if need be 
function LateUpdate () {
	if(StageId>=0){
...
//goes to the next stage in the array when called 
function NextStage(){
	StageId++;
